...
<head>
    ...
    <link rel="stylesheet" type="text/css"  href='{{ asset('journal/sun') }}/css/clear.css' />
    <link rel="stylesheet" type="text/css"  href='{{ asset('journal/sun') }}/css/common.css' />
    <link rel="stylesheet" type="text/css"  href='{{ asset('journal/sun') }}/css/font-awesome.min.css' />
    <link rel="stylesheet" type="text/css"  href='{{ asset('journal/sun') }}/css/carouFredSel.css' />
    <link rel="stylesheet" type="text/css"  href='{{ asset('journal/sun') }}/css/prettyPhoto.css' />
    <link rel="stylesheet" type="text/css"  href='{{ asset('journal/sun') }}/css/sm-clean.css' />
    <link rel="stylesheet" type="text/css"  href='{{ asset('journal/sun') }}/style.css' />

    <!--[if lt IE 9]>
    <script src="{{ asset('journal/sun') }}/js/html5shiv.js"></script>
    <script src="{{ asset('journal/sun') }}/js/respond.min.js"></script>
    <![endif]-->
...
<table class="doc-loader">
    ...
    <tr>
        <td>
            <img src="{{ asset('journal/sun') }}/images/ajax-document-loader.gif" alt="Loading...">
        </td>
    </tr>
    </tbody>
</table>
...
<div class="body-wrapper">
    <div class="content-1330 header-holder center-relative">
        <div class="header-logo left">
            ...
            <h1 class="site-title">
                <a href="index.html">
                    <img src="{{ asset('journal/sun') }}/images/sunDefaultLogo.png" alt="Sun-">
                </a>
            </h1>
    ...
    <div id="content" class="site-content content-1330 center-relative">
        <article>
            ...
            <h1 class="entry-title">wysiwyg editor</h1>
        ...
        <div class="content-1330 center-relative">
            <ul>
                <li class="left-footer-content">
                    Copyright &copy; <script>document.write(new Date().getFullYear());</script> Crafted with <i class="fa fa-heart"></i> by <a href="http://fluidtechglobal.com">Fluidtech Global</a>.
                </li>
                <li class="center-footer-content">
                    <a href="index.html">
                        <img src="{{ asset('journal/sun') }}/images/sunDefaultLogoFooter.png" alt="Sun-">
                    </a>
                </li>
...
<!--Load JavaScript-->
<script src="{{ asset('journal/sun') }}/js/jquery.js"></script>
<script src='{{ asset('journal/sun') }}/js/jquery.fitvids.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.smartmenus.min.js'></script>
<script src='{{ asset('journal/sun') }}/js/imagesloaded.pkgd.js'></script>
<script src='{{ asset('journal/sun') }}/js/isotope.pkgd.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.carouFredSel-6.0.0-packed.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.mousewheel.min.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.touchSwipe.min.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.easing.1.3.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.prettyPhoto.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.ba-throttle-debounce.min.js'></script>
<script src='{{ asset('journal/sun') }}/js/jquery.nicescroll.min.js'></script>
<script src='{{ asset('journal/sun') }}/js/main.js'></script>
</body>
</html>
