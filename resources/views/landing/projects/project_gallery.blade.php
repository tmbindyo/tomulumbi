...
<header id="header" class="header">
    <div class="container-fluid">
        <hgroup>
            ...
            <h1> <a href="{{route('tomulumbi')}}" title="tomulumbi"><img src="{{ asset('themes/personal_albums/pixca') }}/images/logo.png" alt="tomulumbi" title="tomulumbi"/></a> </h1>
                ...
                <div class="menu-expanded">
                    ...
                    <div class="main-menu">
                        <ul>
                            ...
                            <li><a href="{{route('project.show',$project->id)}}">Back To Project</a></li>
                        </ul>
                    </div>
                </div>
            </nav>
...
<main class="main-wrapper" id="container">
    ...
    <div class="wrapper">
        <div class="">
            <ul class="{{$project->thumbnail_size->reference}} masonry">
...
<footer class="footer">
    ...
    <div class="container footer-bot">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-6 col-md-3 col-lg-3"> <img src="{{ asset('themes/personal_albums/pixca') }}/images/footer-logo.png" alt="tomulumbi" title="tomulumbi"/>
