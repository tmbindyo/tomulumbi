    ...
    <div class="carousel h-100 slide" data-ride="carousel" id="welcomeSlider">
        ...
        <div class="carousel-inner h-100">
            ...
            @foreach($designGallery as $image)
                <div class="carousel-item h-100 bg-img @if($loop->index == 0) active @endif" style="background-image: url({{Minio::getUserMediumFileUrl( $image->upload->pixels1500 )}});">
        ...
        <ol class="carousel-indicators">
            @foreach($designGallery as $image)
                <li data-target="#welcomeSlider" data-slide-to="{{$loop->index}}" class="@if($loop->index == 0) active @endif bg-img" style="background-image: url({{Minio::getUserMediumFileUrl( $image->upload->pixels100 )}});"></li>
            @endforeach
        </ol>
    </div>
</section>
