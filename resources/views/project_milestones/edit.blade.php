                        ...
                        <form method="post" action="{{ route('project.project_milestone.update', [$project->id, $projectMilestone]) }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea class="form-control" name="description" id="input-description" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}"  required rows="5">{{$projectMilestone->description}}</textarea>
