...
<div class="modal fade addCampaign" tabindex="-1" role="dialog" aria-labelledby="addCampaign" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addCampaign">Add Campaign</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{ route('admin.campaign.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                ...
                                <input name="expected_revenue" id="expected_revenue" placeholder="expected revenue" type="text" class="mb-2 form-control" {{ $errors->has('expected_revenue') ? ' is-invalid' : '' }} required="required">
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group">
                                ...
                                <input name="budgeted_cost" id="budgeted_cost" placeholder="0" type="text" class="mb-2 form-control" {{ $errors->has('budgeted_cost') ? ' is-invalid' : '' }} required="required">
                                <i>budgeted cost</i>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="expected_response" id="expected_response" placeholder="expected response" type="text" class="mb-2 form-control" {{ $errors->has('expected_response') ? ' is-invalid' : '' }} required="required">
