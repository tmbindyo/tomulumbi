...
<div class="modal fade addProjectType" tabindex="-1" role="dialog" aria-labelledby="addProjectType" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addProjectTypeTitle">Add Project Type</h5>
