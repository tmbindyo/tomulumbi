...
<div class="modal fade addExpenseAccount" tabindex="-1" role="dialog" aria-labelledby="addExpenseAccount" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addExpenseAccountTitle">Add Expense Account</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{ route('admin.expense.account.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="code" id="code" placeholder="code" type="text" class="form-control" {{ $errors->has('code') ? ' is-invalid' : '' }} required="required">
                        <i>code</i>
                    </div>
