...
<div class="modal fade editDesignCoverImage" tabindex="-1" role="dialog" aria-labelledby="editDesignCoverImage" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editDesignCoverImage">Design Cover Image</h5>
