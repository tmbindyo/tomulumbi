{{-- edit product modal --}}
<div class="modal fade editClientProofDownloadSettings" tabindex="-1" role="dialog" aria-labelledby="editClientProofDownloadSettings" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editClientProofDownloadSettings">Edit Client Proof Download Settings {{$album->name}}</h5>
