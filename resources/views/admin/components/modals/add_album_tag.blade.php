{{-- add album tag modal --}}
    <div class="modal fade addAlbumTag" tabindex="-1" role="dialog" aria-labelledby="addAlbumTag" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addAlbumagTitle">Add Album Tag</h5>
