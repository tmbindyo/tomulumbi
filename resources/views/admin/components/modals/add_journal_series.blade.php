...
<div class="modal fade addJournalSeries" tabindex="-1" role="dialog" aria-labelledby="addJournalSeries" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addJournalSeries">Add Journal Series</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{ route('admin.journal.series.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="name" id="journal_series_name" placeholder="name" type="text" class="mb-2 form-control" {{ $errors->has('name') ? ' is-invalid' : '' }} required="required">
                        <i>name</i>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            {{--  Customer  --}}
                            <div class="checkbox checkbox-info">
                                <input id="is_journal_series_tudeme" name="is_tudeme" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_tudeme') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal">
                                <label for="is_tudeme">
                                    Tudeme
                                </label>
                            </div>
