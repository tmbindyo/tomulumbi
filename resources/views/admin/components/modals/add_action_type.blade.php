...
<div class="modal fade addActionType" tabindex="-1" role="dialog" aria-labelledby="addActionType" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addAlbumagTitle">Add Action Type</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{ route('admin.action.type.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                    @csrf
