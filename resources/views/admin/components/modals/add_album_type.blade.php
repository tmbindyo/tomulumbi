{{-- add album type modal --}}
<div class="modal fade addAlbumTypes" tabindex="-1" role="dialog" aria-labelledby="addAlbumType" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addAlbumTypeTitle">Add Album Type</h5>
