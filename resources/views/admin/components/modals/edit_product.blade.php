{{-- edit product modal --}}
<div class="modal fade editProduct" tabindex="-1" role="dialog" aria-labelledby="editProduct" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editProduct">Edit Product {{$product->name}}</h5>
            ...
            <div class="modal-body">
                ...
                <form method="post" action="{{ route('admin.product.update',$product->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                    @csrf
                    ...
                    <div class="position-relative form-group">
                        ...
                        <input name="name" id="name" value="{{$product->name}}" type="text" class="mb-2 form-control" {{ $errors->has('name') ? ' is-invalid' : '' }} required="required">
                        <i>name</i>
                    </div>
                    ...
                    <div class="position-relative form-group">
                        ...
                        <textarea id="description" name="description" class="mb-2 form-control {{ $errors->has('description') ? ' is-invalid' : '' }}">{{$product->description}}</textarea>
                        <i>description</i>
                    </div>
