...
<div class="modal fade addCampaignType" tabindex="-1" role="dialog" aria-labelledby="addCampaignType" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addCampaignTypeTitle">Add Campaign Type</h5>
