                                ...
                                <form method="post" action="{{ route('admin.transaction.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                                    ...
                                    <div class="row">
                                        <div class="col-md-1">
                                            {{--  Customer  --}}
                                            <div class="checkbox checkbox-info">
                                                <input id="is_transfer" name="is_transfer" type="checkbox" @if($withdrawal or $deposit) checked @endif >
                                            ...
                                            <div class="has-warning">
                                                <select name="source_account" class="select-2 form-control input-lg">
                                                    ...
                                                    @foreach($accounts as $sourceAccount)
                                                        <option @if($withdrawal) @if($withdrawal->id == $sourceAccount->id) selected @endif @endif value="{{$sourceAccount->id}}" >{{$sourceAccount->name}} [Ksh. {{$sourceAccount->balance}}]</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="has-warning">
                                                <select name="destination_account" class="select-2 form-control input-lg">
                                                    ...
                                                    @foreach($accounts as $depositAccount)
                                                        <option @if($deposit) @if($deposit->id == $depositAccount->id) selected @endif @endif value="{{$depositAccount->id}}" >{{$depositAccount->name}} [Ksh. {{$depositAccount->balance}}]</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
