...
@section('title', $campaignType->name.' Campaign Type')
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.campaign.type.update',$campaignType->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$campaignType->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$campaignType->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$campaignType->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$campaignType->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$campaignType->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        Campaigns ({{$campaignType->campaigns->count()}})
                        <div class="btn-actions-pane-right">
                            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".addCampaign"><i class="fa fa-plus"></i> Campaign</button>
                        </div>
                    </div>

                        <div class="card-body"><h5 class="card-title">Asset Campaigns</h5>
                                ...
                                <tbody>
                                    @foreach($campaignType->campaigns as $campaign)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.campaign.show', $campaign->id) }}" class="mb-2 mr-2 btn btn-primary">View</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
...
@include('admin.components.modals.add_campaign')
