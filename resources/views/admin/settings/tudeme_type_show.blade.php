...
@section('title', $tudemeType->name.' Tudeme Type')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Tudeme Type</h5>
                        <form method="post" action="{{ route('admin.tudeme.type.update',$tudemeType->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$tudemeType->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$tudemeType->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$tudemeType->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$tudemeType->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$tudemeType->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body"><h5 class="card-title">Tudeme </h5>
                            <table class="mb-0 table table-bordered table-hover table-striped dataTables-example" >
                                ...
                                <tbody>
                                    @foreach($tudemeTudemeTypes as $meal)
                                        <tr>
