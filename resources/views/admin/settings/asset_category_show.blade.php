...
@section('title', $assetCategory->name.' Asset Category')
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.asset.category.update',$assetCategory->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$assetCategory->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$assetCategory->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$assetCategory->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$assetCategory->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$assetCategory->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        Assets ({{$assetCategory->assets->count()}})
                        <div class="btn-actions-pane-right">
                            <a href="{{route('admin.asset.create')}}" type="button" class="btn btn-primary btn-lg" ><i class="fa fa-plus"></i> Asset</a>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    @foreach($assetCategory->assets as $asset)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.asset.show', $asset->id) }}" class="mb-2 mr-2 btn btn-primary">View</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
