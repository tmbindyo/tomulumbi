...
@section('title', $subType->name.' Sub Type')
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.sub.type.update',$subType->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$subType->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>
                            ...
                            <div class="position-relative form-group">
                                ...
                                <select required="required" style="width: 100%" name="type" id="type" class="type-select form-control input-lg">
                                    ...
                                    @foreach ($types as $type)
                                        <option @if($subType->type_id == $type->id) selected @endif value="{{$type->id}}">{{$type->name}}</option>
                                    @endforeach
                                </select>
                                <i>type</i>
                            </div>
                            ...
                            <div class="position-relative form-group">
                                ...
                                <textarea id="description" name="description" class="mb-2 form-control {{ $errors->has('description') ? ' is-invalid' : '' }}">{{$subType->description}}</textarea>
                                <i>description</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$subType->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$subType->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$subType->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$subType->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        Price Lists ({{$subType->price_lists->count()}})
                        <div class="btn-actions-pane-right">
                            <a href="{{route('admin.product.create')}}" type="button" class="btn btn-primary btn-lg" ><i class="fa fa-plus"></i> Product</a>
                        </div>
                    </div>
