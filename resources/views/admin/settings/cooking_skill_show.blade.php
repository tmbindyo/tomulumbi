...
@section('title', $cookingSkill->name.' Cooking Skill')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Cooking Skill</h5>
                        <form method="post" action="{{ route('admin.cooking.skill.update',$cookingSkill->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            @csrf
                            @if ($errors->any())
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$cookingSkill->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingSkill->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingSkill->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingSkill->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingSkill->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body"><h5 class="card-title">Cooking Skill Meals</h5>
                            <table class="mb-0 table table-bordered table-hover table-striped dataTables-example" >
                                ...
                                <tbody>
                                    @foreach($cookingSkillMeals as $meal)
                                        <tr>
                                            <td>{{$meal->name}}</td>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.cooking.skill.show', $meal->id) }}" class="mb-2 mr-2 btn btn-primary">View</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
