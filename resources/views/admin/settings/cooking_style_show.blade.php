...
@section('title', $cookingStyle->name.' Cooking Style')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Cooking Style</h5>
                        <form method="post" action="{{ route('admin.cooking.style.update',$cookingStyle->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$cookingStyle->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingStyle->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingStyle->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingStyle->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$cookingStyle->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
                                ...
                                <tbody>
                                    @foreach($cookingStyleMeals as $meal)
                                        <tr>
                                            ...
                                            <td>{{$meal->meal->tudeme->description}}</td>
                                            <td>{{$meal->meal->tudeme->user->name}}</td>
