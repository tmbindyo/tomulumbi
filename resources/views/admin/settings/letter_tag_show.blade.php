...
@section('title', $letterTag->name.' Letter Tag')
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        <h5 class="card-title">Letter Tag</h5>
                        <form method="post" action="{{ route('admin.letter.tag.update',$letterTag->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$letterTag->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$letterTag->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$letterTag->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$letterTag->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$letterTag->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        <div class="card-body"><h5 class="card-title">Letter Tag Meals</h5>
                            <table class="mb-0 table table-bordered table-hover table-striped dataTables-example" >
                                ...
                                <tbody>
                                    @foreach($letterLetterTags as $letterTagLetter)
                                        <tr>
                                            <td>{{$letterTagLetter->letter->name}}</td>
                                            <td>{{$letterTagLetter->letter->description}}</td>
                                            <td>{{$letterTagLetter->letter->user->name}}</td>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.letter.show', $letterTagLetter->letter->id) }}" class="mb-2 mr-2 btn btn-primary">View</a>
                                                </div>
                                            </td>
                                        </tr>
                                    @endforeach
