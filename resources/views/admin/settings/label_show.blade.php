...
@section('title', $label->name.' Label')
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('admin.label.update',$label->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input name="name" id="name" value="{{$label->name}}" type="text" class="form-control">
                                <i>name</i>
                            </div>

                            <div class="position-relative form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" name="is_tudeme" class="form-check-input" @if($label->is_tudeme) checked @endif> Tudeme
                                </label>
                                <br>
                                <i>is tudeme</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$label->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$label->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$label->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$label->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
                                ...
                                <tbody>
                                    @foreach($label->journal_labels as $labelJournal)
                                        <tr>
                                            ...
                                            <td class="text-right">
                                                <div class="btn-group">
                                                    <a href="{{ route('admin.journal.show', $labelJournal->journal->id) }}" class="mb-2 mr-2 btn btn-primary">View</a>
                                                    @if($labelJournal->journal->status->name == "Deleted")
                                                        <a href="{{ route('admin.journal.restore', $labelJournal->journal->id) }}" class="mb-2 mr-2 btn btn-warning">Restore</a>
                                                    @else
                                                        <a href="{{ route('admin.journal.delete', $labelJournal->journal->id) }}" class="mb-2 mr-2 btn btn-danger">Delete</a>
                                                    @endif
                                                </div>
                                            </td>
                                        </tr>
