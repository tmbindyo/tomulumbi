                        ...
                        <div class="table-responsive">
                            <table class="table shoping-cart-table">
                                ...
                                <tr>
                                    ...
                                    <td class="desc">
                                        <h3>
                                            <a href="{{route('admin.product.show',$product->id)}}" class="text-navy">
                                                {{$product->name}}
                                            </a>
                                        </h3>
...
{{--                                            {!! $product->product->description !!}--}}
                                        ...
                                        <div class="m-t-sm">
                                            <a href="{{route('admin.expense.product.delete',$product->id)}}" class="text-warning"><i class="fa fa-trash"></i> Remove item</a>
                                        </div>
                                    </td>
...
{{--                                @if($expense->customer->is_admin == 1)--}}
{{--                                    --}}{{--  if admin  --}}
{{--                                    <address>--}}
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="m-b-md">
                                    ...
                                    <a href="{{route('admin.transaction.create',$expense->id)}}" class="pull-right btn btn-primary btn-outline">Make Payment</a>
                                </div>
            ...
            <div class="wrapper wrapper-content project-manager">
                ...
                <ul class="tag-list" style="padding: 0">
                    @if($expense->is_order == 1)
                        <li><a href="{{route('admin.order.show',$expense->order->id)}}"><i class="fa fa-shopping-cart"></i> {{$expense->order->order_number}}</a></li>
                    @endif
                        @if($expense->is_album == 1)
                            @if($expense->album->album_type_id = "ca64a5e0-d39b-4f2c-a136-9c523d935ea4")
                                <li><a href="{{route('admin.client.proof.show',$expense->album->id)}}"><i class="fa fa-camera"></i> {{$expense->album->name}}</a></li>
                            @elseif($expense->album->album_type_id = "6fdf4858-01ce-43ff-bbe6-827f09fa1cef")
                                <li><a href="{{route('admin.personal.album.show',$expense->album->id)}}"><i class="fa fa-camera"></i> {{$expense->album->name}}</a></li>
                            @endif
                    @endif
                    @if($expense->is_project == 1)
                        <li><a href="{{route('admin.project.show',$expense->project->id)}}"><i class="fa fa-trello"></i> {{$expense->project->name}}</a></li>
                    @endif
