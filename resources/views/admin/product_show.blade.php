                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="">
                        <ul class="pending-to-do">
                            @foreach($product->pending_to_dos as $pendingToDo)
                                <li>
                                    <div>
                        ...
                        <ul class="in-progress-to-do">
                            @foreach($product->in_progress_to_dos as $inProgressToDo)
                                <li>
                                    <div>
                        ...
                        <ul class="overdue-to-do">
                            @foreach($product->overdue_to_dos as $overdueToDo)
                                <li>
                                    <div>
                        ...
                        <ul class="completed-to-do">
                            @foreach($product->completed_to_dos as $completedToDo)
                                <li>
                                    <div>
