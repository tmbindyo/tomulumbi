                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <div class="">
                                <form method="post" action="{{ route('business.order.update',$order->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    @csrf
                                            ...
                                            <div class="has-warning">
                                                <select name="customer" class="select2_demo_3 form-control input-lg">
                                                    ...
                                                    @foreach($customers as $customer)
                                                        <option @if($customer->id == $order->customer_id)selected @endif value="{{$customer->id}}">{{$customer->company_name}}: {{$customer->last_name}}, {{$customer->first_name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <br>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="has-warning">
                                                        <div class="input-group date">
                                                            ...
                                                            <input type="text" value="{{$order->date}}" name="date" id="date" class="form-control input-lg" required>
                                                        </div>
                                                        <i> order date.</i>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="has-warning">
                                                        <div class="input-group date">
                                                            ...
                                                            <input type="text" value="{{$order->due_date}}" name="due_date" id="due_date" class="form-control input-lg" required>
                                                        </div>
                                                        <i> due date.</i>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        <table class="table table-bordered" id = "order_table">
                                            ...
                                            @php
                                                $product_index = 0
                                            @endphp
                                            @foreach($order->sale_products as $saleProduct)
                                                <tr>
                                                    <td>
                                    ...
                                    <div class="row">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input name="subtotal" type = "number" class="pull-right form-control" id = "items-subtotal" readonly value="{{$order->subtotal}}">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <input name="discount" oninput = "itemTotalChange()" type="number" class="form-control" id = "adjustment-value" value = "{{$order->discount}}">
                                            </div>
                                            <div class="col-md-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type = "number" name = "grand_total" id = "grand-total" class="pull-right form-control" value = "{{$order->total}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
