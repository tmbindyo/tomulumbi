                        ...
                        <div class="ibox-content">
                            ...
                            <div class="">
                                <form method="post" action="{{ route('admin.order.update',$order->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="has-warning" id="data_1">
                                                        <div class="input-group date">
                                                            ...
                                                            <input type="text" required="required" value="{{$order->date}}" name="expiry_date" id="expiry_date" class="form-control input-lg">
                                                        </div>
                                                        <i>expiry date</i>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="has-warning" id="data_1">
                                                        <div class="input-group date">
                                                            ...
                                                            <input type="text" required="required" value="{{$order->due_date}}" name="due_date" id="due_date" class="form-control input-lg">
                                                        </div>
                                                        <i>due date</i>
                                                        <span id="inputSuccess2Status4" class="sr-only">(success)</span>
                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <table class="table table-bordered" id = "estimate_table">
                                                ...
                                                @foreach($order->order_products as $product)
                                                    <tr>
                                                        <td>
                                                            <select onchange = "itemSelected(this)" data-placement="Select" name="item_details[{{$product_index}}][item]" class="select2_demo_product form-control input-lg item-select">
                                                                <option></option>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <input name="subtotal" type = "number" class="pull-right input-lg form-control" id = "items-subtotal" readonly value="{{$order->subtotal}}">
                                            <i>subtotal</i>
                                        </div>
                                        <div class="col-md-4">
                                    ...
                                    <div class="row">
                                        <div class="has-warning">
                                            <div class="col-md-12">
                                                <div class="has-warning">
                                                    <textarea id="customer_notes" rows="5" name="customer_notes" class="resizable_textarea form-control input-lg" required="required">{{$order->customer_notes}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    ...
    console.log('tableValueArrayIndex');
    console.log(tableValueArrayIndex);
