                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="form-group">
                                        <div class="has-warning">
                                            <input type="email" id="phone_number" name="phone_number" required="required" class="form-control col-md-7 col-xs-12 input-lg" required="required" placeholder="Phone Number">
                                        </div>
                                    </div>
