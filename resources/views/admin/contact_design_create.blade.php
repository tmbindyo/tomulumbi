...
@section('title', ' Contact Design Create')
    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <a href="{{route('admin.client.proofs')}}">Designs</a>
                </li>
                <li class="active">
                                    ...
                                    <div class="has-warning">
                                        <select name="contacts[]" class="select2_demo_client form-control input-lg" multiple="multiple">
                                            @foreach($contacts as $contactOption)
                                                <option @if($contactOption->id == $designContact->id) selected @endif value="{{$contactOption->id}}">{{$contactOption->first_name}} {{$contactOption->last_name}}</option>
                                            @endforeach
                                        </select>
                                        <i>Select Client.</i>
                                    </div>
