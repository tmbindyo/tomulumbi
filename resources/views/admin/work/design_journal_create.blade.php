    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong><a href="{{route('admin.design.show',$design->id)}}">Project</a></strong>
                </li>
                <li class="active">
                    <strong>Project Journal Create</strong>
                </li>
            </ol>
        </div>
    </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <select required="required" name="design" class="select2_demo_label form-control input-lg">
