        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    ...
                    {{-- <a href="{{route('admin.personal.album.create')}}" class="btn btn-success btn-lg"><i class="fa fa-plus"></i> Personal Album </a> --}}
            ...
            <div class="col-lg-12">
                <div>
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <button type="button" class="btn btn-warning m-r-sm">{{$personalAlbumsStatusCount['previewPersonalAlbums']}}</button>
                                Preview
                            </td>
                            <td>
                                <button type="button" class="btn btn-info m-r-sm">{{$personalAlbumsStatusCount['hiddenPersonalAlbums']}}</button>
                                Hidden
                            </td>
                            <td>
                                <button type="button" class="btn btn-success m-r-sm">{{$personalAlbumsStatusCount['publishedPersonalAlbums']}}</button>
                                Published
                            </td>
                        </tr>
                        </tbody>
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        Personal Albums ({{$albums->count()}})
                        <div class="btn-actions-pane-right">
                            {{-- <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".addPersonalAlbum"><i class="fa fa-plus"></i> Personal Album</button> --}}
                        </div>
                    </div>

                    <div class="card-body"><h5 class="card-title">Personal Albums</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                @if($album->status->name == "Deleted")
                                                    <a href=""{{ route('admin.personal.album.restore', $album->id) }}" class="mb-2 mr-2 btn btn-warning">Restore</a>
                                                @else
                                                    <a href=""{{ route('admin.personal.album.delete', $album->id) }}" class="mb-2 mr-2 btn btn-danger">Delete</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
