...
@section('title', 'Client Proof '.$album->name.' Images')
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Client Proof {{$album->name}} Images
            ...
            <div class="page-title-actions">
                ...
                <div class="d-inline-block dropdown">
                    ...
                    <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".addClientProofSet"><i class="fa fa-plus"></i> Client Proof Set</button>
                    <a href="{{ route('admin.client.proof.show', $album->id) }}" class="btn btn-lg btn-primary">View</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="tab-content">
                @foreach($albumSets as $albumSet)
                    <div class="tab-pane @if($loop->iteration == 1) active @endif" id="tab-eg13-{{$loop->index}}" role="tabpanel">
                        <form id="my-awesome-dropzone-{{$loop->index}}" class="dropzone" action="{{route('admin.client.proof.set.image.upload',$albumSet->id)}}">
                            @csrf
...
@include('admin.components.modals.add_client_proof_set')
