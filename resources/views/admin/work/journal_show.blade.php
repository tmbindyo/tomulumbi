...
@section('title', 'Journal '.$journal->name)
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".editJournal"><i class="fa fa-paint-brush"></i> Journal</button>
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".editJournalCoverImage"><i class="fa fa-paint-brush"></i> Cover Image</button>
                <a href="{{route('admin.journal.text.show',$journal->id)}}" class="btn btn-success btn-lg" ><i class="fa fa-eye"></i> Journal Text</a>
            </div>
        </div>
    </div>
                ...
                <ul class="nav nav-justified">
                    ...
                    <li class="nav-item">
                        <a href="#tab-minimal-2" data-toggle="tab" class="nav-link active minimal-tab-btn-2">
                            ...
                            <div class="tab-subheading">Journals</div>
                        </a>
                    </li>
                    <li class="nav-item">
...
@include('admin.components.modals.edit_journal')
@include('admin.components.modals.edit_journal_cover_image')
...
@section('js')
    <script>
        $(document).ready(function() {
            ...
            // Set date
            let date_set = {!! json_encode($journal->date) !!};
