        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    ...
                    {{-- <a href="{{route('admin.personal.album.create')}}" class="btn btn-success btn-lg"><i class="fa fa-plus"></i> Client Proof </a> --}}
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        Client Proofs ({{$albums->count()}})
                        <div class="btn-actions-pane-right">
                            {{-- <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".addPersonalAlbum"><i class="fa fa-plus"></i> Client Proof</button> --}}
                        </div>
                    </div>

                    <div class="card-body"><h5 class="card-title">Client Proofs</h5>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                @if($album->status->name == "Deleted")
                                                    <a href=""{{ route('admin.client.proof.restore', $album->id) }}" class="mb-2 mr-2 btn btn-warning">Restore</a>
                                                @else
                                                    <a href=""{{ route('admin.client.proof.delete', $album->id) }}" class="mb-2 mr-2 btn btn-danger">Delete</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
