...
@section('title', 'Journal Series '.$journalSeries->name)
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            <div class="page-title-heading">
                ...
                <div>Journal Series {{$journalSeries->name}}
            ...
            <div class="page-title-actions">
                ...
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".editJournalSeries"><i class="fa fa-paint-brush"></i> Journal Series</button>
            </div>
        </div>
    </div>
                ...
                <ul class="nav nav-justified">
                    ...
                    <li class="nav-item">
                        <a href="#tab-minimal-2" data-toggle="tab" class="nav-link active minimal-tab-btn-2">
                            ...
                            <div class="tab-subheading">Journal Seriess</div>
                        </a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="tabs-animated-shadow tabs-animated nav">
                    <li class="nav-item">
                        <a role="tab" class="nav-link active" id="tab-c-0" data-toggle="tab" href="#asset-actions">
                            <span>Journals ({{$journalSeriesJournals->count()}})
                            </span>
                        </a>
                    </li>
                </ul>
...
@include('admin.components.modals.edit_journal_series')
