                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                @if($project->status->name == "Deleted")
                                                    <a href=""{{ route('admin.project.restore', $project->id) }}" class="mb-2 mr-2 btn btn-warning">Restore</a>
                                                @else
                                                    <a href=""{{ route('admin.project.delete', $project->id) }}" class="mb-2 mr-2 btn btn-danger">Delete</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
