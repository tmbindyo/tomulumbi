...
@section('title', 'Personal Album '.$album->name)
    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                ...
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".editPersonalAlbum"><i class="fa fa-paint-brush"></i> Personal Album</button>
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".editPersonalAlbumCoverImage"><i class="fa fa-paint-brush"></i> Cover Image</button>
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".editPersonalAlbumDownloadSettings"><i class="fa fa-paint-brush"></i> Download Settings</button>
                <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".addPersonalAlbumEmailRestriction"><i class="fa fa-plus"></i> Email Restriction</button>
                ...
                <ul class="nav nav-justified">
                    ...
                    <li class="nav-item">
                        <a href="#tab-minimal-2" data-toggle="tab" class="nav-link active minimal-tab-btn-2">
                            ...
                            <div class="tab-subheading">Personal Albums</div>
                        </a>
                    </li>
                    <li class="nav-item">
...
@include('admin.components.modals.edit_personal_album')
@include('admin.components.modals.edit_personal_album_cover_image')
@include('admin.components.modals.edit_personal_album_download_settings')
@include('admin.components.modals.add_personal_album_email_restriction')
