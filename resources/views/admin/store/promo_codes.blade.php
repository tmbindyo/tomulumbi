        ...
        <div class="app-page-title">
            <div class="page-title-wrapper">
                ...
                <div class="page-title-actions">
                    ...
                    {{-- <a href="{{route('admin.product.create')}}" class="btn btn-success btn-lg"><i class="fa fa-plus"></i> Product</a> --}}
                </div>
            </div>
        </div>
            ...
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-header">
                        ...
                        Promo Codes ({{$promoCodes->count()}})
                        <div class="btn-actions-pane-right">
                            <button type="button" class="btn btn-success btn-lg" data-toggle="modal" data-target=".addPromoCode"><i class="fa fa-plus"></i> Promo Code</button>
                        </div>
                    </div>

                    <div class="card-body"><h5 class="card-title">Promo Codes</h5>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                @if($promoCode->status_id == "b810f2f1-91c2-4fc9-b8e1-acc068caa03a")
                                                    <a href=""{{ route('admin.promo.code.restore', $promoCode->id) }}" class="mb-2 mr-2 btn btn-warning">Restore</a>
                                                @else
                                                    <a href=""{{ route('admin.promo.code.delete', $promoCode->id) }}" class="mb-2 mr-2 btn btn-danger">Delete</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
