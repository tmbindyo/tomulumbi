                ...
                <div class="col-lg-12">
                    <div class="ibox">
                        <div class="ibox-title">
                            <h5>Album Registration <small>Form</small></h5>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required="required" name="tags[]" class="select2_demo_2 form-control input-lg" multiple="multiple">
                                                @foreach($tags as $tag)
                                        ...
                                        <div class="form-group">
                                            <label>Categories <span class="required">*</span>
                                            </label>
                                            <select required="required" name="categories[]" class="select2_demo_2 form-control input-lg" multiple="multiple">
                                                @foreach($categories as $category)
                                                    <option value="{{$category->id}}">{{$category->name}}</option>
                                                @endforeach
                                            </select>
                                            <i>What kind of collection is this? Separate your categorys with a comma. e.g. wedding, outdoor, summer</i>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <input name="is_homepage_visible" type="checkbox" class="js-switch_5" checked />
