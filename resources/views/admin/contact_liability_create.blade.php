                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="has-warning" id="data_1">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" required="required" name="due_date" class="form-control input-lg" value="7/27/2019">
                                        </div>
                                        <i>due date</i>
                                        <span id="inputSuccess2Status4" class="sr-only">(success)</span>
                                    </div>
                                    ...
                                    <div class="has-warning">
                                        <select name="contact" class="select2_demo_tag form-control input-lg">
                                            ...
                                            @foreach ($contacts as $contact)
                                                <option @if($contactLiability->id == $contact->id) selected @endif value="{{$contact->id}}">{{$contact->first_name}} {{$contact->last_name}} @if($contact->organization)[{{$contact->organization->name}}]@endif</option>
                                            @endforeach
                                        </select>
