                    ...
                    <div class="ibox-content">
                        <div class="row">
                            <div class="col-sm-8 col-md-offset-2">
                                <form method="post" action="{{ route('admin.album.type.show.update',$albumType->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    @csrf
