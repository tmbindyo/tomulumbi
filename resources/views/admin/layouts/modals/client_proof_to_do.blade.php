    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content animated bounceInRight">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route('admin.client.proof.to.do.save',$album->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div class="has-warning">
                                <select name="album" class="select2_demo_2 form-control input-lg" disabled="">
