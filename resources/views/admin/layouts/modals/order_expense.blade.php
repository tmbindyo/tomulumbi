<div class="modal inmodal" id="expenseRegistration" tabindex="-1" role="dialog" aria-labelledby="expenseRegistrationLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content animated bounceInRight">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                <i class="fa fa-dollar modal-icon"></i>
                <h4 class="modal-title">Expense Registration</h4>
            </div>
            <div class="modal-body">
                <form method="post" action="{{ route('admin.order.update.status',$order->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                    @csrf
