                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input name="is_tudeme" type="checkbox" class="js-switch_3" checked />
                                    <br>
                        ...
                        <div class="col-lg-8">
                            <div class="has-warning">
                                <select name="tudeme" class="select2_demo_2 form-control input-lg">
                                    <option value="{{$tudeme->id}}">{{$tudeme->name}}</option>
                                </select>
                                <i>What tudeme does the to do belong to</i>
                            </div>
                        </div>
                    </div>
                    <br>
