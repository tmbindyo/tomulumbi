                ...
                <form method="post" action="{{ route('admin.to.do.store') }}" autocomplete="off" class="form-horizontal form-label-left">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="has-warning">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <input name="is_journal_series" type="checkbox" class="js-switch_2" checked />
                                    <br>
                        ...
                        <div class="col-lg-8">
                            <div class="has-warning">
                                <select name="journal_series" class="select2_demo_2 form-control input-lg">
                                    <option>Select Journal Series</option>

                                    <option value="{{$journalSeries->id}}" selected>{{$journalSeries->name}}</option>
                                </select>
                                <i>What journal series does the to do belong to</i>
                            </div>
                        </div>
                    </div>
