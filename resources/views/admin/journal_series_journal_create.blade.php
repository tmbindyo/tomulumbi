    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong><a href="{{route('admin.journal.series.show',$journalSeries->id)}}">Journal Series</a></strong>
                </li>
                <li class="active">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="checkbox" name="is_journal_series" class="js-switch_3" checked/>
                                            <i>is journal_series</i>
                                        </div>
                                        <div class="col-md-6">
                                            <select required="required" name="journal_series" class="select2_demo_label form-control input-lg">
