                                ...
                                <div class="widget style1 navy-bg">
                                    <div class="row vertical-align">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$subType->user->name}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="widget style1 {{$subType->status->label}}">
                                    <div class="row vertical-align">
                                        <div class="col-xs-3">
                                            <i class="fa fa-ellipsis-v fa-3x"></i>
                                        </div>
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$subType->status->name}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="widget style1 navy-bg">
                                    <div class="row vertical-align">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$subType->created_at}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="widget style1 navy-bg">
                                    <div class="row vertical-align">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$subType->updated_at}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
