            ...
            <div class="col-lg-12">
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>Deal Registration <small>Form</small></h5>
                                    ...
                                    <div class="col-md-6">
                                        <div class="has-warning" id="data_1">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="starting_date" class="form-control input-lg">
                                            </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="has-warning" id="data_1">
                                            <div class="input-group date">
                                                ...
                                                <input type="text" name="closing_date" class="form-control input-lg">
                                            </div>
...
<script>
    $(document).ready(function() {
        ...
        document.getElementById("starting_date").value = date_today;
        document.getElementById("closing_date").value = date_today;
