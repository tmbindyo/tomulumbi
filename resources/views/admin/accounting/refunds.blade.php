        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body"><h5 class="card-title">Refunds</h5>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                @if($refund->status_id == "b810f2f1-91c2-4fc9-b8e1-acc068caa03a")
                                                    <a href="{{ route('admin.refund.restore', $refund->id) }}" class="mb-2 mr-2 btn btn-primary">Restore</a>
                                                @else
                                                    <a href="{{ route('admin.refund.delete', $refund->id) }}" class="mb-2 mr-2 btn btn-danger">Delete</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
