...
@section('title', 'Transfer '.$transfer->reference)
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="#" autocomplete="off" class="form-horizontal form-label-left">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <input required name="paid" id="paid" type="number" class="form-control" required="required" value="{{$transfer->amount}}"/>
                                <i>paid.</i>
                            </div>
                            ...
                            <div class="position-relative form-group">
                                ...
                                <select required="required" style="width: 100%" {{ $errors->has('account') ? ' is-invalid' : '' }} name="source_account" id="source_account" class="account-transfer-select form-control input-lg">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <select required="required" style="width: 100%" {{ $errors->has('account') ? ' is-invalid' : '' }} name="destination_account" id="destination_account" class="account-transfer-select form-control input-lg">
                            ...
                            <div class="position-relative form-group">
                                ...
                                <textarea name="about" id="about" class="form-control" required="required">{{$transfer->notes}}</textarea>
                                <i>about.</i>
                            </div>
                        ...
                        <div class="card mb-3 widget-content bg-midnight-bloom">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$transfer->user->name}}</div>
                                </div>
                        ...
                        <div class="card mb-3 widget-content bg-arielle-smile">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$transfer->status->name}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-grow-early">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$transfer->created_at}}</div>
                                </div>
                                <div class="widget-content-right">
                        ...
                        <div class="card mb-3 widget-content bg-premium-dark">
                            <div class="widget-content-wrapper text-white">
                                <div class="widget-content-left">
                                    ...
                                    <div class="widget-subheading">{{$transfer->updated_at}}</div>
                                </div>
                                <div class="widget-content-right">
                            ...
                            <ul class="tabs-animated-shadow tabs-animated nav">
                                <li class="nav-item">
                                    <a role="tab" class="nav-link active" id="tab-c-0" data-toggle="tab" href="#refunds">
                                        <span>Expenses ({{$transfer->expenses->count()}})</span>
                                    </a>
                                </li>
                            </ul>
                                    ...
                                    <div class="card-hover-shadow card-border mb-3 card">
                                        <div class="card-header">
                                            ...
                                            <div class="btn-actions-pane-right">
                                                <a type="button" class="btn btn-success btn-lg" href="{{route('admin.transfer.expense.create',$transfer->id)}}"><i class="fa fa-plus"></i> Expense</a>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // {!! json_encode($transfer->date) !!};
            let date_set = {!! json_encode($transfer->date) !!};
