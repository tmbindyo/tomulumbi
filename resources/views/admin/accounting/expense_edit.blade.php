...
@section('title','Expense '.$expense->reference.' Edit')
                            ...
                            <form method="post" action="{{ route('admin.expense.update',$expense->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="position-relative form-group">
                                            ...
                                            <input required name="date" id="date" value="{{$expense->date}}" type="text" class="form-control" data-toggle="datepicker"/>
                                            <i>date.</i>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-bordered" id = "expense_table">
                                            ...
                                            <tbody>
                                                ...
                                                @foreach($expense->expense_items as $expense_item)
                                                    <tr>
                                                        <td>
                                                            <input name="item_details[{{$expense_index}}][item]" type="text" class="form-control input-lg item-detail" value="{{$expense_item->name}}">
                                                        </td>
                                                        <td>
                                                            <input oninput = "changeItemQuantity(this)" name="item_details[{{$expense_index}}][quantity]" type="number" class="form-control input-lg item-quantity" value = "{{$expense_item->quantity}}" min = "0">
                                                        </td>
                                                        <td>
                                                            <input oninput = "changeItemRate(this)" name="item_details[{{$expense_index}}][rate]" type="number" class="form-control input-lg item-rate" placeholder="E.g +10, -10" value = "{{$expense_item->rate}}" min = "0">
                                                        </td>
                                                        <td>
                                                            <input oninput = "itemTotalChange()" onchange = "this.oninput()" name="item_details[{{$expense_index}}][amount]" type="number" class="form-control input-lg item-total" placeholder="E.g +10, -10" value = "{{$expense_item->amount}}" min = "0">
                                                        </td>
                                                        <td>
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="subtotal" id="items-subtotal" readonly value="{{$expense->sub_total}}" type="number" class="mb-2 form-control" {{ $errors->has('balance') ? ' is-invalid' : '' }} required="required">
                                            <i>subtotal</i>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="adjustment" id="adjustment-value" oninput="itemTotalChange()" type="number" class="mb-2 form-control" {{ $errors->has('balance') ? ' is-invalid' : '' }} required="required" value="{{$expense->adjustment}}">
                                            <i>adjustment</i>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="position-relative form-group">
                                            ...
                                            <input name="grand_total" id="grand-total" type="number" class="mb-2 form-control" {{ $errors->has('balance') ? ' is-invalid' : '' }} required="required" value="{{$expense->total}}" readonly>
                                            <i>total</i>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="checkbox checkbox-info">
                                            <input id="is_order" name="is_order" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_order') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_order) checked @endif>
                                            <label for="is_order">
                                                Order
                                            </label>
                                        </div>
                                            ...
                                            <div class="has-warning">
                                                <select name="order" class="order-select form-control input-lg">
                                                    ...
                                                    @foreach($orders as $order)
                                                        <option @if($expense->is_order) @if($expense->order_id == $order->id) selected @endif @endif value="{{$order->id}}" >{{$order->order_number}} [{{$order->total}}] ({{$order->created_at}})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_album" name="is_album" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_album') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_album) checked @endif>
                                            <label for="is_album">
                                                Album
                                            </label>
                                        </div>
                                                ...
                                                <select name="album" class="album-select form-control input-lg">
                                                    ...
                                                    <optgroup label="Personal">
                                                        @foreach($personalAlbums as $album)
                                                            <option @if($expense->is_album) @if($expense->album_id == $album->id) selected @endif @endif value="{{$album->id}}" >{{$album->name}}</option>
                                                        @endforeach
                                                    </optgroup>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_project" name="is_project" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_project') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_project) checked @endif>
                                            ...
                                            <div class="has-warning">
                                                <select name="project" class="project-select form-control input-lg">
                                                    ...
                                                    @foreach($projects as $project)
                                                        <option @if($expense->is_project) @if($expense->project_id == $project->id) selected @endif @endif value="{{$project->id}}" >{{$project->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_design" name="is_design" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_design') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_design) checked @endif>
                                            <label for="is_design">
                                                Design
                                            </label>
                                        </div>
                                            ...
                                            <div class="has-warning">
                                                <select name="design" class="design-select form-control input-lg">
                                                    ...
                                                    @foreach($designs as $design)
                                                        <option @if($expense->is_design) @if($expense->design_id == $design->id) selected @endif @endif value="{{$design->id}}" >{{$design->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_transfer" name="is_transfer" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_transfer') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_transfer) checked @endif>
                                            ...
                                            <div class="has-warning">
                                                <select name="transfer" class="transfer-select form-control input-lg">
                                                    ...
                                                    @foreach($transfers as $transfer)
                                                        <option @if($expense->is_transfer) @if($expense->transfer_id == $transfer->id) selected @endif @endif value="{{$transfer->id}}" >{{$transfer->reference}} [{{$transfer->amount}}] ({{$transfer->date}})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_campaign" name="is_campaign" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_campaign') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_campaign) checked @endif>
                                            ...
                                            <div class="has-warning">
                                                <select name="campaign" class="campaign-select form-control input-lg">
                                                    ...
                                                    @foreach($campaigns as $campaign)
                                                        <option @if($expense->is_campaign) @if($expense->campaign_id == $campaign->id) selected @endif @endif value="{{$campaign->id}}" >{{$campaign->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_asset" name="is_asset" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_asset') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_asset) checked @endif>
                                            <label for="is_asset">
                                                Asset
                                            </label>
                                        </div>
                                            ...
                                            <div class="has-warning">
                                                <select name="asset" class="asset-select form-control input-lg">
                                                    ...
                                                    @foreach($assets as $asset)
                                                        <option @if($expense->is_asset) @if($expense->asset_id == $asset->id) selected @endif @endif value="{{$asset->id}}" >{{$asset->name}} [{{$asset->reference}}]</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_liability" name="is_liability" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_liability') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_liability) checked @endif>
                                            ...
                                            <div class="has-warning">
                                                <select name="liability" class="liability-select form-control input-lg">
                                                    ...
                                                    @foreach($liabilities as $liability)
                                                        <option @if($expense->is_liability) @if($expense->liability_id == $liability->id) selected @endif @endif value="{{$liability->id}}" >{{$liability->reference}} [{{$liability->amount}}] ({{$liability->date}})</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        ...
                                        <div class="checkbox checkbox-info">
                                            ...
                                            <br>
                                            <input id="is_recurring" name="is_recurring" type="checkbox" data-on="Yes" data-off="No" {{ $errors->has('is_recurring') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_recurring) checked @endif>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="has-warning">
                                            ...
                                            <div class="has-warning">
                                                <select name="frequency" class="frequency-select form-control input-lg">
                                                    ...
                                                    @foreach($frequencies as $frequency)
                                                        <option @if($expense->is_recurring) @if($expense->frequency_id == $frequency->id) selected @endif @endif value="{{$frequency->id}}" >{{$frequency->name}}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <i>frequency.</i>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="checkbox checkbox-info">
                                                    <input id="is_contact" name="is_contact" type="checkbox"  data-on="Yes" data-off="No" {{ $errors->has('is_recurring') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_contact) checked @endif>
                                                ...
                                                <div class="has-warning">
                                                    <select name="contact" class="contact-select form-control input-lg">
                                                        ...
                                                        @foreach($contacts as $contact)
                                                            <option @if($expense->is_contact) @if($expense->contact_id == $contact->id) selected @endif @endif value="{{$contact->id}}">{{$contact->first_name}} {{$contact->last_name}} @if($contact->organization) [{{$contact->organization->name}}] @endif </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="has-warning">
                                            <select name="status" class="status-select form-control input-lg" required>
                                                ...
                                                @foreach($expenseStatuses as $status)
                                                    <option @if($expense->status_id == $status->id) selected @endif value="{{$status->id}}" >{{$status->name}}</option>
                                                @endforeach
                                            </select>
                                            <i>status.</i>
                                        </div>
                                        ...
                                        {{--  Customer  --}}
                                        <div class="checkbox checkbox-info">
                                            <input id="is_draft" name="is_draft" type="checkbox"  data-on="Yes" data-off="No" {{ $errors->has('is_draft') ? ' is-invalid' : '' }} data-toggle="toggle" data-size="normal" @if($expense->is_draft) checked @endif>
                                            <label for="is_draft">
                                                Draft
                                             </label>
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="has-warning">
                                            <textarea required name="notes" placeholder="Notes" class="form-control" rows="7">{!! $expense->notes !!}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                        <button type="submit" class="btn btn-outline btn-lg btn-block btn-success">{{ __('SAVE') }}</button>
                                    </div>
                                </div>
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            // {!! json_encode($expense->date) !!};
            let date_set = {!! json_encode($expense->date) !!};
            ...
            let is_recurring = {!! json_encode($expense->is_recurring) !!};
            console.log(is_recurring)
            if(is_recurring === 1){

                let start_repeat_date_set = {!! json_encode($expense->start_repeat) !!};
                let start_repeat_substrings = start_repeat_date_set.split('-');
                console.log(start_repeat_substrings)
                var set_start_date = start_repeat_substrings[1] + '/' + start_repeat_substrings[2] + '/' + start_repeat_substrings[0];
                document.getElementById("start_date").value = set_start_date;

                let end_repeat_date_set = {!! json_encode($expense->end_repeat) !!};
                let end_repeat_substrings = end_repeat_date_set.split('-');
                var set_end_date = end_repeat_substrings[1] + '/' + end_repeat_substrings[2] + '/' + end_repeat_substrings[0];
                document.getElementById("end_date").value = set_end_date;
    ...
    <script>
        ...
        var tableValueArrayIndex = {{$expense_index}};
