    ...
    <div class="wrapper wrapper-content animated fadeInRight">
        ...
        <div class="row">
            ...
            <div class="ibox float-e-margins">
                ...
                <tbody>
                @foreach($contactTypeContacts as $contactTypeContact)
                    <tr class="gradeX">
                        <td>{{$contactTypeContact->name}}</td>
                        <td>{{$contactTypeContact->email}}</td>
                        <td>{{$contactTypeContact->phone_number}}</td>
                        <td>{{$contactTypeContact->user->name}}</td>
                        <td>
                            <span class="label {{$contactTypeContact->status->label}}">{{$contactTypeContact->status->name}}</span>
                        </td>
                        <td class="text-right">
{{--                                todo check why route is contact but id is contact type--}}
                            <div class="btn-group">
                                <a href="{{ route('admin.contact.show', $contactTypeContact->id) }}" class="btn-white btn btn-xs">View</a>
                            </div>
                        </td>
                    </tr>
                @endforeach
