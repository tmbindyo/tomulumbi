                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <dl class="dl-horizontal">
                                        <dt>Status:</dt> <dd><span class="label {{$kit->status->label}}">{{$kit->status->name}}</span></dd>
                                    </dl>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-5">
                                    <dl class="dl-horizontal">
                                        ...
                                        <dt>Created by:</dt> <dd>{{$kit->user->name}}</dd>
                                    </dl>
                                </div>
                                <div class="col-lg-7" id="cluster_info">
                                    <dl class="dl-horizontal" >

                                        <dt>Last Updated:</dt> <dd>{{$kit->updated_at}}</dd>
                                        <dt>Created:</dt> <dd> {{$kit->created_at}} </dd>
                                    </dl>
                                </div>
                            </div>
