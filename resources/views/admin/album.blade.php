                    ...
                    <div class="tabs-container">
                        ...
                        <div class="tab-content">
                            <div id="collection_settings" class="tab-pane active">
                                <div class="panel-body">
                                    <div class="col-md-10 col-md-offset-1">
                                        ...
                                        <form method="post" action="{{ route('admin.album.update.collection.settings',$album->id) }}" autocomplete="off">
                                            @csrf
                                    ...
                                    <div class="row m-t-lg">
                                        <div class="col-md-6">
                                            ...
                                            <form method="post" action="{{ route('admin.album.update.design',$album->id) }}" autocomplete="off" enctype = "multipart/form-data">
                                                ...
                                                {{--  Album Grid style  --}}
                                                <div class="col-md-10 col-md-offset-1">
                                                    <h3 class="text-center">Grid style</h3>
                                                    <div class="form-group">
                                                        <select class="form-control m-b input-lg" name="grid_style" required>
                                                            @foreach($gridStyles as $gridStyle)
                                                                <option value="{{$gridStyle->id}}" @if($gridStyle->id === $album->grid_style_id) selected @endif>{{$gridStyle->name}}</option>
                                                            @endforeach
                                                        </select>
                                                        <i>Vertical emphasizes portrait photos, and Horizontal emphasizes landscape photos..</i>
                                                    </div>
                                                </div>
                                                ...
                                                {{--  Album Grid spacing  --}}
                                                <div class="col-md-10 col-md-offset-1">
                                                    <h4 class="text-center">Grid Spacing</h4>
                                                    <div class="form-group">
                                                        <select class="form-control m-b input-lg" name="grid_spacing" required>
                                                            @foreach($thumbnailSizes as $thumbnailSize)
                                                                <option value="{{$thumbnailSize->id}}" @if($thumbnailSize->id === $album->grid_spacing_id) selected @endif>{{$thumbnailSize->name}}</option>
                                                            @endforeach
                                                        </select>
                            ...
                            <div id="privacy" class="tab-pane">
                                <div class="panel-body">
                                    <form method="post" action="{{ route('admin.album.update.privacy',$album->id) }}" autocomplete="off">
                                        @csrf
                            ...
                            <div id="download" class="tab-pane">
                                <div class="panel-body">
                                    <form method="post" action="{{ route('admin.album.update.download',$album->id) }}" autocomplete="off">
                                        @csrf
                                        <div class="col-md-10 col-md-offset-1">
                                                                ...
                                                                @foreach($albumDownloadRestrictionEmails as $albumDownloadRestrictionEmail)
                                                                    <tr class="gradeX">
                                                                        ...
                                                                        <td class="text-center">
                                                                            <div class="btn-group">
                                                                                <a href="{{route('admin.album.restrict.to.specific.email.delete',$albumDownloadRestrictionEmail->id)}}" class="btn-danger btn btn-block btn-xs">Delete</a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                @endforeach
...
@include('admin.layouts.modals.album_set')
@include('admin.layouts.modals.album_to_do')
@include('admin.layouts.modals.album_cover_image')
...
@section('js')
    ...
    <script>
        $('.updateAlbumSetVisibility').on('click',function(){
            ...
            xhr.open("GET", '{{url('admin/album/set/status/')}}'+'/'+id);
    ...
    <script>
        $('.updateAlbumSetDownload').on('click',function(){
            ...
            //send value by ajax to server
            var xhr = new XMLHttpRequest();
            xhr.open("GET", '{{url('admin/album/set/download/status/')}}'+'/'+id);
            xhr.setRequestHeader('Content-Type', '');
            xhr.send();
            xhr.onload = function() {
                alert(this.responseText);
    ...
    <script>
        $('.generateAlbumPassword').on('click',function(){
            ...
            //send value by ajax to server
            var xhr = new XMLHttpRequest();
            xhr.open("GET", '{{url('admin/album/generate/password')}}'+'/'+id);
            xhr.setRequestHeader('Content-Type', '');
            xhr.send();
            xhr.onload = function() {
    ...
    <script>
        $('.generateAlbumPin').on('click',function(){
            ...
            //send value by ajax to server
            var xhr = new XMLHttpRequest();
            xhr.open("GET", '{{url('admin/album/generate/pin')}}'+'/'+id);
            xhr.setRequestHeader('Content-Type', '');
            xhr.send();
            xhr.onload = function() {
    ...
    <script>
        $('.restrictToEmail').on('click',function(){
            ...
            //send value by ajax to server
            var xhr = new XMLHttpRequest();
            xhr.open("GET", '{{url('admin/album/restrict/to/specific')}}'+'/'+id +'/email/'+email);
            xhr.setRequestHeader('Content-Type', '');
            xhr.send();
            xhr.onload = function() {
                alert(this.responseText);
