    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-9">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong><a href="{{route('admin.client.proofs')}}">Letters</a></strong>
                </li>
                <li class="active">
                    <strong>Letter Create</strong>
                </li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <br>
                                    <div class="has-warning">
                                        <select name="letter_tags[]" class="select2_demo_letter_tags form-control input-lg" multiple="multiple">
                                            <option></option>
