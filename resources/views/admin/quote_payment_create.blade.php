                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    ...
                                    <div class="has-warning">
                                        <input type="number" id="amount" name="amount" required="required" value="{{$quote->total}}" class="form-control input-lg">
                                        <i>amount</i>
                                    </div>
                                    <br>
                                        ...
                                        <div class="col-md-2">
                                            <div class="has-warning">
                                                <div class="col-md-12 col-sm-12 col-xs-12">
                                                    <input name="is_quote" type="checkbox" class="js-switch_4" checked />
                                                    <br>
                                                    <i>check if quote.</i>
                                                </div>
                                            </div>
