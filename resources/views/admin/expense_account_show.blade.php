                                ...
                                <div class="widget style1 navy-bg">
                                    <div class="row vertical-align">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$expenseAccount->user->name}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="widget style1 {{$expenseAccount->status->label}}">
                                    <div class="row vertical-align">
                                        <div class="col-xs-3">
                                            <i class="fa fa-ellipsis-v fa-3x"></i>
                                        </div>
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$expenseAccount->status->name}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="widget style1 navy-bg">
                                    <div class="row vertical-align">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$expenseAccount->created_at}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-3">
                                <div class="widget style1 navy-bg">
                                    <div class="row vertical-align">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            <h3 class="font-bold">{{$expenseAccount->updated_at}}</h3>
                                        </div>
                                    </div>
                                </div>
                            </div>
