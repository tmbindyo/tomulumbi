        ...
        <div class="row">
            <div class="col-md-12">
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body"><h5 class="card-title">Contacts</h5>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <div class="btn-group">
                                                ...
                                                @if($contact->status->name == "Deleted")
                                                    <a href=""{{ route('admin.contact.restore', $contact->id) }}" class="mb-2 mr-2 btn btn-warning">Restore</a>
                                                @else
                                                    <a href=""{{ route('admin.contact.delete', $contact->id) }}" class="mb-2 mr-2 btn btn-danger">Delete</a>
                                                @endif
                                            </div>
                                        </td>
                                    </tr>
