                                ...
                                <form method="post" action="{{ route('admin.quote.update',$quote->id) }}" autocomplete="off" class="form-horizontal form-label-left">
                                    ...
                                    <div class="row">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input name="subtotal" type = "number" class="pull-right form-control" id = "items-subtotal" readonly value="{{$quote->subtotal}}">
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <input name="discount" oninput = "itemTotalChange()" type="number" class="form-control" id = "adjustment-value" value = "{{$quote->discount}}">
                                            </div>
                                            <div class="col-md-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <input type = "number" name = "grand_total" id = "grand-total" class="pull-right form-control" value = "{{$quote->total}}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <hr>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 b-r">
                                            <input type="checkbox" name="is_draft" class="js-switch_3"/ @if($quote->is_draft == 1) checked @endif>
                                            <i>draft</i>
                                            <br>
                                            <br>
                                            <br>
                                        ...
                                        <div class="col-md-8">
                                            <div class="has-warning">
                                                <textarea rows="3" id="customer_notes" name="customer_notes" required="required" class="form-control input-lg">{{$quote->customer_notes}}</textarea>
                                                <i>customer notes</i>
                                            </div>
                                            <br>
                                            <div class="has-warning">
